...
const APP_URL = (process.env.APP_URL || 'https://deiiwocoffee.com').trim();
...
// Cambiar a 'Deiiwo Coffee <atencionalcliente@deiiwocoffee.com>' después de verificar dominio
...
app.listen(PORT, () => {
    ...
    console.log(`🌐 Sitio web: ${APP_URL}`);
    console.log(`🔗 API Pagos: ${APP_URL}/api/v1/payments/create-link`);
    console.log(`📨 Webhook: ${APP_URL}/api/v1/payments/webhook`);
